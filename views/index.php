...
<body>
                ...
                <div class="cad">
                    <div class="cadContent">
                        ...
                        <form action="cadastro.php" id="formCadIndex" class="cadForm">
                            ...
                            <input type="email" placeholder="voltaic@email.com" name="emailInput" class="cadInput" id="emailInput" require>
                            <label for="pswInput" class="cadLabel">Senha</label><br>
                            <input type="password" placeholder="✱✱✱✱✱✱✱✱" name="pswInput" class="cadInput" id="pswInput" require>
            ...
            <div class="bottomSide">
                ...
                <div class="home-card">
                    <div class="cardContent">
                        ...
                        <p class="card-text">Contribua com a ampliação de uma das maiores fontes de energia limpa e sustentável</p>
                        <figure class="figureHome">
    ...
    <footer>
        ...
        <ul class="list">
            <li><a href="#bg-cadastro">Página Inicial</a></li>
